...
<head>
    ...
    <meta name="description" content="scrambleAdmin">
    ...
    <link rel="stylesheet" href="/skin/admin///skin/admin/assets/css/cs-skin-elastic.css">
    <link rel="stylesheet" href="/skin/admin/assets/css/style.css">
...
<body>
    ...
    <script src="/skin/admin/assets/js/main.js"></script>
    ...
    <script src="/skin/admin/assets/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="/skin/admin/assets/js/init/fullcalendar-init.js"></script>
